...
type CreatePacketReq struct {
	...
	Name     string `protobuf:"bytes,3,opt,name=Name,proto3" json:"name,omitempty" form:"name" vd:"(len($) > 0 && len($) < 30)"`
	Content  string `protobuf:"bytes,4,opt,name=Content,proto3" form:"content" form:"content" json:"content,omitempty" vd:"(len($) > 0 && len($) < 1000)"`
