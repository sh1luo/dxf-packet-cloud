...
type CreatePacketReq struct {
	...
	Content  string `protobuf:"bytes,4,opt,name=Content,proto3" json:"content,omitempty" form:"content" vd:"(len($) > 0 && len($) < 2000)"`
...
var file_packet_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x28, 0x24, 0x29, 0x20, 0x3c, 0x20, 0x32, 0x30, 0x30, 0x30, 0x29, 0xe2, 0xbb, 0x18,
