...
type CreatePacketReq struct {
	...
	Content  string `protobuf:"bytes,4,opt,name=Content,proto3" json:"content,omitempty" form:"content" vd:"(len($) > 0 && len($) < 6000)"`
	Channel  string `protobuf:"bytes,5,opt,name=Channel,proto3" json:"channel,omitempty" form:"channel" vd:"(len($) > 0 && len($) < 50)"`
...
var file_packet_proto_rawDesc = []byte{
	...
	0x6c, 0x65, 0x6e, 0x28, 0x24, 0x29, 0x20, 0x3c, 0x20, 0x36, 0x30, 0x30, 0x30, 0x29, 0xe2, 0xbb,
